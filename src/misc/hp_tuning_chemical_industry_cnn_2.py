...
os.chdir('../../')
feature_name = 'Chemical_Industry'
...
if not evaluation:
    if search:
        ...
        np.save('src/Models/model_checkpoints/train_history/chemical_industry.npy', train_history.history)
        np.save('src/Models/model_checkpoints/train_history/chemical_industry_best_params.npy', grid_result.best_params_)
    else:
        best_parameters = np.load('src/Models/model_checkpoints/train_history/chemical_industry_best_params.npy',
        ...
        mc = ModelCheckpoint('src/Models/model_checkpoints/best_models/best_model_Chemical_Industry',
    ...
    tuned_model = load_model('src/Models/model_checkpoints/best_models/best_model_Chemical_Industry',
